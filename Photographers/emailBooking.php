...
try {
    ...
    $message1 = $body . "<br>" . "<br>"."Name: ". $fname ." " .$lname . "<br>"."Please reply to this email. "."<br>" ."Thank You ". "<br>" . $Pemail;
                                ...
                                <div class="content_box_inner">
                                    ...
                                    <div class="mt75 row justify-content-center">
                                            <div class="col-lg-6 col-12">
                                                <input type="text"name="name" value="<?php echo $fname ." " .  $lname?>" placeholder="Name" class="form-control">
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <input type="email" name="email" value="<?php echo $Uemail?>" placeholder="E-Mail" class="form-control">
                                            </div>
                                            <div class="col-12">
