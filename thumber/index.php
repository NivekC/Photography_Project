...
<div class="swiper-slide cover" style="background-image: url('images/img_1.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      <h2>Interior Deco Photos</h2>
      <div class="scrollbar-inner style-scrollbar-sm js-scrollbar-container">
        <p class="mb-0">They say that the best room also have something to say about the people who live in them...</p>
      </div>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_3.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      ...
      <p class="mb-0">Cherish all your happy moments; They make a fine cushion for old age...</p>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_4.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      <h2>Food</h2>
      <p class="mb-0">Part of the secret of success in life is to eat what you like and let the food fight it out from inside...</p>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_5.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      <h2>Fashion</h2>
      <p class="mb-0">You can have anything you want in life if you dress for it. Dress like you are already Famous...</p>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_6.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      <h2>Architecture</h2>
      <p class="mb-0">In the big picture, architecture is the art and science of making sure that our cities and buildings fit with the way we want to live our lives...</p>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_7.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      <h2>Food Again!</h2>
      <p class="mb-0">One cannot think well, love well, sleep well, if one has not dined well... Luhyas' understand this more than anyone</p>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_8.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      <h2>Nature</h2>
      <p class="mb-0">Keep close to Nature's heart... and break clear away, once in awhile, and climb a mountain or spend a week in the woods. Wash your spirit clean...</p>
    </div>
  </div>
</div>
...
<div class="swiper-slide cover" style="background-image: url('images/img_10.jpg');">
  ...
  <div class="img-info">
    ...
    <div class="img-info-content">
      ...
      <p class="mb-0">“A friend is someone who knows all about you and still loves you.”</p>
    </div>
  </div>
</div>
